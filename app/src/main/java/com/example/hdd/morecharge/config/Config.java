...
public class Config {
    ...
    public static String apiKey = "OGSP6TYeXGv4GkIq6IU0yrUs";
    public static String secretKey = "DGjCUYXcmBRHW8gEn7WI5U0Sbd5XUa89";
    public static String licenseID = "com-JK-HDD-face-android";
