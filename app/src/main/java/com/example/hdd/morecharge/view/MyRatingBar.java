...
public class MyRatingBar extends View {
    ...
    public MyRatingBar(Context mContext, AttributeSet attrs) {
        super(mContext, attrs);
        init(mContext, attrs);
    }

    public MyRatingBar(Context mContext, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context mContext, AttributeSet attrs){
        ...
        flag = typedArray.getString(R.styleable.star_flag);
