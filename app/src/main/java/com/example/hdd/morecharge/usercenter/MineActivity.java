...
import com.example.hdd.morecharge.receive.main.ReceiveMainActivity;
import com.example.hdd.morecharge.release.MainActivity;
...
public class MineActivity extends BaseActivity {
    ...
    @OnClick({R.id.rb_receive, R.id.rb_release,R.id.iv_user_portrait,R.id.tv_go_order,R.id.lly_scan})
