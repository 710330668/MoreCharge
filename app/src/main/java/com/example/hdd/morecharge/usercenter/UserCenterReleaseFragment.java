...
import com.example.hdd.morecharge.receive.main.WaterMelonCreditActivity;
import com.example.hdd.morecharge.receive.main.integrate.MyIntegrateActivity;
import com.example.hdd.morecharge.usercenter.auth.MyAuthActivity;
import com.example.hdd.morecharge.usercenter.setting.SettingActivity;
import com.example.hdd.morecharge.usercenter.wallet.MyWalletActivity;
...
public class UserCenterReleaseFragment extends BaseFragment {
    Unbinder unbinder;

    @Override
    protected int setLayoutResouceId() {
        return R.layout.fragment_user_center_release;
    }
    ...
    @OnClick({R.id.ll_mine_authentication, R.id.ll_mine_wallet, R.id.ll_mine_order, R.id.ll_top_layout, R.id.ll_receipt_code, R.id.ll_scan, R.id.ll_watermelon_credit, R.id.ll_mine_score, R.id.ll_complain_advice, R.id.ll_mine_setting, R.id.ll_mine_message})
