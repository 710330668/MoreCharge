...
public class GoodsPullUpToLoadMoreBak extends ViewGroup {
    public static String TAG = GoodsPullUpToLoadMoreBak.class.getName();
    ...
    public GoodsPullUpToLoadMoreBak(Context context) {
        super(context);
        init();
    }

    public GoodsPullUpToLoadMoreBak(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public GoodsPullUpToLoadMoreBak(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (GoodsScrollView) getChildAt(0);
                bottomScrollView = (GoodsScrollView) getChildAt(1);
                topScrollView.setScrollListener(new GoodsScrollView.ScrollListener() {
                    @Override
