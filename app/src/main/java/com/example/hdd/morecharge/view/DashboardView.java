...
public class DashboardView extends View {
    ...
    private void init() {
        ...
        mBgColors = new int[]{ContextCompat.getColor(getContext(), R.color.FF9A2E)};
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(calculateCreditDescription(), mCenterX, mCenterY, mPaint);
    ...
    private String getFormatTimeStr() {
        ...
        return String.format("更新时间:%s", mDateFormat.format(new Date()));
    }
