package com.example.com.morecharge.receive.main.scan.scanfilterdown;
...
public class SearchAdapter extends Madapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (selectedPosition == position) {
            holder.employeesquery.setBackgroundColor(Color.parseColor("#EAEAEA"));
            holder.name.setTextColor(Color.parseColor("#333333"));
        } else {
            holder.employeesquery.setBackgroundColor(Color.parseColor("#F3F3F3"));
